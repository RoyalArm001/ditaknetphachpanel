...
for(const name of ['index.html','locales.js','i18n.js','app.js','domain.js','rack3d.js','styles.css','manifest.webmanifest','pwa.js','personal-store.js','sw.js','icon-192.png','icon-512.png','favicon.ico'])fs.copyFileSync(path.join(root,name),path.join(out,name));
