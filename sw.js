...
const SHELL=['/assets/DejaVuSans.ttf','/','/locales.js','/i18n.js','/index.html','/styles.css','/domain.js','/personal-store.js','/drive-store.js','/app.js','/rack3d.js','/pwa.js','/manifest.webmanifest','/icon-192.png','/icon-512.png','/favicon.ico','/exceljs.min.js'];
